 ...
 524                     ; 96         tempcalibfactor = currentCalibrationFactor1 / 100.00;
 526  018e b600          	ld	a,_currentCalibrationFactor1
 527  0190 5f            	clrw	x
 528  0191 97            	ld	xl,a
 ...
 666                     ; 110         tempcalibfactor = currentCalibrationFactor2 / 100.00;
 668  0210 b600          	ld	a,_currentCalibrationFactor2
 669  0212 5f            	clrw	x
 670  0213 97            	ld	xl,a
 ...
 950                     ; 138         tempcalibfactor = powerCalibrationFactor1 / 100.00;
 952  0314 b600          	ld	a,_powerCalibrationFactor1
 953  0316 5f            	clrw	x
 954  0317 97            	ld	xl,a
...
1092                     ; 152         tempcalibfactor = powerCalibrationFactor2 / 100.00;
1094  0396 b600          	ld	a,_powerCalibrationFactor2
1095  0398 5f            	clrw	x
...
1415                     	xref.b	_powerCalibrationFactor2
1416                     	xref.b	_powerCalibrationFactor1
1417                     	xref.b	_currentCalibrationFactor3
1418                     	xref.b	_currentCalibrationFactor2
1419                     	xref.b	_currentCalibrationFactor1
1420                     	xref.b	_voltageCalibrationFactor3
1421                     	xref.b	_voltageCalibrationFactor2
1422                     	xref.b	_voltageCalibrationFactor1
1423                     	xdef	_calcWatt3
1424                     	xdef	_calcWatt2
1425                     	xdef	_calcWatt1
1426                     	xdef	_calcAmp3
1427                     	xdef	_calcAmp2
1428                     	xdef	_calcAmp1
1429                     	xdef	_calcVolt3
1430                     	xdef	_calcVolt2
1431                     	xdef	_calcVolt1
1432                     	xdef	_Watt_Phase3
1433                     	xdef	_Ampere_Phase3
1434                     	xdef	_Voltage_Phase3
1435                     	xdef	_Watt_Phase2
1436                     	xdef	_Ampere_Phase2
1437                     	xdef	_Voltage_Phase2
1438                     	xdef	_Watt_Phase1
1439                     	xdef	_Ampere_Phase1
1440                     	xdef	_Voltage_Phase1
1441                     .const:	section	.text
1442  0000               L572:
1443  0000 4c604e99      	dc.w	19552,20121
1444  0004               L361:
1445  0004 47951407      	dc.w	18325,5127
1446  0008               L15:
1447  0008 495a28f2      	dc.w	18778,10482
1448  000c               L14:
1449  000c 42c80000      	dc.w	17096,0
1450                     	xref.b	c_x
1470                     	xref	c_ftol
1471                     	xref	c_fmul
1472                     	xref	c_ultof
