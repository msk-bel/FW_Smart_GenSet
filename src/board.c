...
void timer1Setup(void)
{
	...
	TIM1_ICInit(TIM1_CHANNEL_4, TIM1_ICPOLARITY_FALLING, TIM1_ICSELECTION_DIRECTTI, TIM1_ICPSC_DIV1, 0x00); /* Initialize Input Capture Channel 3 */
	TIM1_CCxCmd(TIM1_CHANNEL_1, ENABLE);																	/* Enable Timer 1 Capture Compare Channel 1 */
	TIM1_CCxCmd(TIM1_CHANNEL_3, ENABLE);																	/* Enable Timer 1 Capture Compare Channel 2 */
	//TIM1_ITConfig(TIM1_IT_UPDATE, ENABLE);																	/* Timer 1 overflow interrupt enable */
	//TIM1_ITConfig(TIM1_IT_CC1, ENABLE);																		/* Timer 1 input capture channel 3 interrupt enable */
	//TIM1_ITConfig(TIM1_IT_CC3, ENABLE);																		/* Timer 1 input capture channel 3 interrupt enable */
