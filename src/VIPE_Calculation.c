...
void calcAmp1(uint32_t ampPeriod1)
{
    ...
    if (checkByte == 'A')
    {
        tempcalibfactor = currentCalibrationFactor1 / 100.00;
...
void calcAmp2(uint32_t ampPeriod2)
{
    ...
    if (checkByte == 'A')
    {
        tempcalibfactor = currentCalibrationFactor2 / 100.00;
...
void calcWatt1(uint32_t wattPeriod1)
{
    ...
    if (checkByte == 'A')
    {
        tempcalibfactor = powerCalibrationFactor1 / 100.00;
...
void calcWatt2(uint32_t wattPeriod2)
{
    ...
    if (checkByte == 'A')
    {
        tempcalibfactor = powerCalibrationFactor2 / 100.00;
