...
void calculateVoltCurrent(uint32_t timeout)
{
  ...
  while (getTics() - discardPulseTics > discardPulseTimeout && !bypassPulseTicsFlag)
  {
    ...
    */
    ...
    else
    {
      ...
      {
        voltagePeriod2 = 0;
        // calcVolt2(voltagePeriod2);//Added by Saqib
        Voltage_Phase2 = 0;
      }
      ...
      {
        currentPeriod2 = 0;
        // calcAmp2(currentPeriod2);//Added by Saqib
        Ampere_Phase2 = 0;
      }
    }
    ...
    */
    ...
    else
    {
      ...
      {
        voltagePeriod1 = 0;
        // calcVolt1(voltagePeriod1);//Added by Saqib
        Voltage_Phase1 = 0;
      }
      else
      {
        currentPeriod1 = 0;
        // calcAmp1(currentPeriod1);//Added by Saqib
        Ampere_Phase1 = 0;
      }
    }
    ...
    */
    ...
    else
    {
      ...
      {
        voltagePeriod3 = 0;
        // calcVolt3(voltagePeriod3);//Added by Saqib
        Voltage_Phase3 = 0;
      }
      else
      {
        currentPeriod3 = 0;
        // calcAmp3(currentPeriod3);//Added by Saqib
        Ampere_Phase3 = 0;
      }
    }
  ...
  // calcAmp1(currentPeriod1);
  // calcVolt1(voltagePeriod1);
  // calcWatt1(powerPeriod1);
  // calcAmp2(currentPeriod2);
  // calcVolt2(voltagePeriod2);
  // calcWatt2(powerPeriod2);
  // calcAmp3(currentPeriod3);
  // calcVolt3(voltagePeriod3);
